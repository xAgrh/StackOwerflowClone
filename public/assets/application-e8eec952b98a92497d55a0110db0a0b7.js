...
(function() {
  $(function() {
    ...
    PrivatePub.subscribe('/questions/' + questionId + '/comments', function(data, channel) {
      ...
      return $('.comments').append('<p>' + comment.body + '</p>');
    });
    return PrivatePub.subscribe('/questions/' + questionId + '/answers/comments', function(data, channel) {
      var comment;
      console.log('questionId');
      comment = $.parseJSON(data['comment']);
      return $('#answer-' + comment.commentable_id + ' .comments_in_answer').append('<p>' + comment.body + '</p>');
    });
  });
